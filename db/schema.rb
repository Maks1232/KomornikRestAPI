...
ActiveRecord::Schema[7.0].define(version: 2023_01_02_152621) do
  ...
  create_table "groupmembers", charset: "utf8mb4", collation: "utf8mb4_general_ci", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.bigint "groupinfo_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["groupinfo_id"], name: "index_groupmembers_on_groupinfo_id"
  ...
  add_foreign_key "groupmembers", "groupinfos"
